	...
	integrations: [
		...
		starlight({
			...
			sidebar: [
				...
				{
					label: 'Module 8: Spec-Driven Development',
					collapsed: true,
					items: [
						{ slug: '08-spec-driven-development/overview' },
						{ slug: '08-spec-driven-development/the-sdd-methodology' },
						{ slug: '08-spec-driven-development/writing-specifications' },
						{ slug: '08-spec-driven-development/task-decomposition' },
						{ slug: '08-spec-driven-development/execution-and-verification' },
						{ slug: '08-spec-driven-development/practical-exercises' },
					],
				},
				{
					label: 'Module 9: Security',
					collapsed: true,
					items: [
						{ label: 'Overview', slug: '09-security/overview' },
						{ label: 'Threat model', slug: '09-security/threat-model' },
						{ label: 'Permissions and sandboxing', slug: '09-security/permissions-and-sandboxing' },
						{ label: 'Credential management', slug: '09-security/credential-management' },
						{ label: 'Code review and validation', slug: '09-security/code-review-practices' },
						{ label: 'Operational safety', slug: '09-security/operational-safety' },
					],
				},
			],
		}),
